...
module cinnabon_qsys_mm_interconnect_0 (
	...
	wire  [148:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> pcie_ip_bar1_0_agent:rp_data
	wire          rsp_mux_src_ready;                                                         // pcie_ip_bar1_0_agent:rp_ready -> rsp_mux:src_ready
	wire    [4:0] rsp_mux_src_channel;                                                       // rsp_mux:src_channel -> pcie_ip_bar1_0_agent:rp_channel
	...
	wire    [4:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> pcie_ip_txs_agent:cp_channel
	...
	wire  [148:0] router_006_src_data;                                                       // router_006:src_data -> rsp_demux_001:sink_data
	...
	wire  [148:0] cmd_demux_001_src1_data;                                                   // cmd_demux_001:src1_data -> cmd_mux_001:sink0_data
	...
	wire  [148:0] cmd_demux_002_src1_data;                                                   // cmd_demux_002:src1_data -> cmd_mux_001:sink1_data
	...
	wire  [148:0] cmd_demux_003_src0_data;                                                   // cmd_demux_003:src0_data -> cmd_mux_001:sink2_data
	...
	wire  [148:0] cmd_demux_004_src0_data;                                                   // cmd_demux_004:src0_data -> cmd_mux_001:sink3_data
	...
	wire  [148:0] rsp_demux_001_src0_data;                                                   // rsp_demux_001:src0_data -> rsp_mux_001:sink1_data
	...
	wire  [148:0] rsp_demux_001_src1_data;                                                   // rsp_demux_001:src1_data -> rsp_mux_002:sink1_data
	...
	wire  [148:0] rsp_demux_001_src2_data;                                                   // rsp_demux_001:src2_data -> rsp_mux_003:sink0_data
	...
	wire  [148:0] rsp_demux_001_src3_data;                                                   // rsp_demux_001:src3_data -> rsp_mux_004:sink0_data
	...
	wire          rsp_mux_003_src_valid;                                                     // rsp_mux_003:src_valid -> sgdma_descriptor_read_rsp_width_adapter:in_valid
	wire  [148:0] rsp_mux_003_src_data;                                                      // rsp_mux_003:src_data -> sgdma_descriptor_read_rsp_width_adapter:in_data
	wire          rsp_mux_003_src_ready;                                                     // sgdma_descriptor_read_rsp_width_adapter:in_ready -> rsp_mux_003:src_ready
	wire    [4:0] rsp_mux_003_src_channel;                                                   // rsp_mux_003:src_channel -> sgdma_descriptor_read_rsp_width_adapter:in_channel
	wire          rsp_mux_003_src_startofpacket;                                             // rsp_mux_003:src_startofpacket -> sgdma_descriptor_read_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_003_src_endofpacket;                                               // rsp_mux_003:src_endofpacket -> sgdma_descriptor_read_rsp_width_adapter:in_endofpacket
	wire          sgdma_descriptor_read_rsp_width_adapter_src_valid;                         // sgdma_descriptor_read_rsp_width_adapter:out_valid -> sgdma_descriptor_read_agent:rp_valid
	wire  [112:0] sgdma_descriptor_read_rsp_width_adapter_src_data;                          // sgdma_descriptor_read_rsp_width_adapter:out_data -> sgdma_descriptor_read_agent:rp_data
	wire          sgdma_descriptor_read_rsp_width_adapter_src_ready;                         // sgdma_descriptor_read_agent:rp_ready -> sgdma_descriptor_read_rsp_width_adapter:out_ready
	wire    [4:0] sgdma_descriptor_read_rsp_width_adapter_src_channel;                       // sgdma_descriptor_read_rsp_width_adapter:out_channel -> sgdma_descriptor_read_agent:rp_channel
	wire          sgdma_descriptor_read_rsp_width_adapter_src_startofpacket;                 // sgdma_descriptor_read_rsp_width_adapter:out_startofpacket -> sgdma_descriptor_read_agent:rp_startofpacket
	wire          sgdma_descriptor_read_rsp_width_adapter_src_endofpacket;                   // sgdma_descriptor_read_rsp_width_adapter:out_endofpacket -> sgdma_descriptor_read_agent:rp_endofpacket
	wire          rsp_mux_004_src_valid;                                                     // rsp_mux_004:src_valid -> sgdma_descriptor_write_rsp_width_adapter:in_valid
	wire  [148:0] rsp_mux_004_src_data;                                                      // rsp_mux_004:src_data -> sgdma_descriptor_write_rsp_width_adapter:in_data
	wire          rsp_mux_004_src_ready;                                                     // sgdma_descriptor_write_rsp_width_adapter:in_ready -> rsp_mux_004:src_ready
	wire    [4:0] rsp_mux_004_src_channel;                                                   // rsp_mux_004:src_channel -> sgdma_descriptor_write_rsp_width_adapter:in_channel
	wire          rsp_mux_004_src_startofpacket;                                             // rsp_mux_004:src_startofpacket -> sgdma_descriptor_write_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_004_src_endofpacket;                                               // rsp_mux_004:src_endofpacket -> sgdma_descriptor_write_rsp_width_adapter:in_endofpacket
	wire          sgdma_descriptor_write_rsp_width_adapter_src_valid;                        // sgdma_descriptor_write_rsp_width_adapter:out_valid -> sgdma_descriptor_write_agent:rp_valid
	wire  [112:0] sgdma_descriptor_write_rsp_width_adapter_src_data;                         // sgdma_descriptor_write_rsp_width_adapter:out_data -> sgdma_descriptor_write_agent:rp_data
	wire          sgdma_descriptor_write_rsp_width_adapter_src_ready;                        // sgdma_descriptor_write_agent:rp_ready -> sgdma_descriptor_write_rsp_width_adapter:out_ready
	wire    [4:0] sgdma_descriptor_write_rsp_width_adapter_src_channel;                      // sgdma_descriptor_write_rsp_width_adapter:out_channel -> sgdma_descriptor_write_agent:rp_channel
	wire          sgdma_descriptor_write_rsp_width_adapter_src_startofpacket;                // sgdma_descriptor_write_rsp_width_adapter:out_startofpacket -> sgdma_descriptor_write_agent:rp_startofpacket
	wire          sgdma_descriptor_write_rsp_width_adapter_src_endofpacket;                  // sgdma_descriptor_write_rsp_width_adapter:out_endofpacket -> sgdma_descriptor_write_agent:rp_endofpacket
	wire          router_003_src_valid;                                                      // router_003:src_valid -> sgdma_descriptor_read_cmd_width_adapter:in_valid
	wire  [112:0] router_003_src_data;                                                       // router_003:src_data -> sgdma_descriptor_read_cmd_width_adapter:in_data
	wire          router_003_src_ready;                                                      // sgdma_descriptor_read_cmd_width_adapter:in_ready -> router_003:src_ready
	wire    [4:0] router_003_src_channel;                                                    // router_003:src_channel -> sgdma_descriptor_read_cmd_width_adapter:in_channel
	wire          router_003_src_startofpacket;                                              // router_003:src_startofpacket -> sgdma_descriptor_read_cmd_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                                // router_003:src_endofpacket -> sgdma_descriptor_read_cmd_width_adapter:in_endofpacket
	wire          sgdma_descriptor_read_cmd_width_adapter_src_valid;                         // sgdma_descriptor_read_cmd_width_adapter:out_valid -> cmd_demux_003:sink_valid
	wire  [148:0] sgdma_descriptor_read_cmd_width_adapter_src_data;                          // sgdma_descriptor_read_cmd_width_adapter:out_data -> cmd_demux_003:sink_data
	wire          sgdma_descriptor_read_cmd_width_adapter_src_ready;                         // cmd_demux_003:sink_ready -> sgdma_descriptor_read_cmd_width_adapter:out_ready
	wire    [4:0] sgdma_descriptor_read_cmd_width_adapter_src_channel;                       // sgdma_descriptor_read_cmd_width_adapter:out_channel -> cmd_demux_003:sink_channel
	wire          sgdma_descriptor_read_cmd_width_adapter_src_startofpacket;                 // sgdma_descriptor_read_cmd_width_adapter:out_startofpacket -> cmd_demux_003:sink_startofpacket
	wire          sgdma_descriptor_read_cmd_width_adapter_src_endofpacket;                   // sgdma_descriptor_read_cmd_width_adapter:out_endofpacket -> cmd_demux_003:sink_endofpacket
	wire          router_004_src_valid;                                                      // router_004:src_valid -> sgdma_descriptor_write_cmd_width_adapter:in_valid
	wire  [112:0] router_004_src_data;                                                       // router_004:src_data -> sgdma_descriptor_write_cmd_width_adapter:in_data
	wire          router_004_src_ready;                                                      // sgdma_descriptor_write_cmd_width_adapter:in_ready -> router_004:src_ready
	wire    [4:0] router_004_src_channel;                                                    // router_004:src_channel -> sgdma_descriptor_write_cmd_width_adapter:in_channel
	wire          router_004_src_startofpacket;                                              // router_004:src_startofpacket -> sgdma_descriptor_write_cmd_width_adapter:in_startofpacket
	wire          router_004_src_endofpacket;                                                // router_004:src_endofpacket -> sgdma_descriptor_write_cmd_width_adapter:in_endofpacket
	wire          sgdma_descriptor_write_cmd_width_adapter_src_valid;                        // sgdma_descriptor_write_cmd_width_adapter:out_valid -> cmd_demux_004:sink_valid
	wire  [148:0] sgdma_descriptor_write_cmd_width_adapter_src_data;                         // sgdma_descriptor_write_cmd_width_adapter:out_data -> cmd_demux_004:sink_data
	wire          sgdma_descriptor_write_cmd_width_adapter_src_ready;                        // cmd_demux_004:sink_ready -> sgdma_descriptor_write_cmd_width_adapter:out_ready
	wire    [4:0] sgdma_descriptor_write_cmd_width_adapter_src_channel;                      // sgdma_descriptor_write_cmd_width_adapter:out_channel -> cmd_demux_004:sink_channel
	wire          sgdma_descriptor_write_cmd_width_adapter_src_startofpacket;                // sgdma_descriptor_write_cmd_width_adapter:out_startofpacket -> cmd_demux_004:sink_startofpacket
	wire          sgdma_descriptor_write_cmd_width_adapter_src_endofpacket;                  // sgdma_descriptor_write_cmd_width_adapter:out_endofpacket -> cmd_demux_004:sink_endofpacket
	...
	wire          pcie_ip_txs_agent_rdata_fifo_src_valid;                                    // pcie_ip_txs_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [65:0] pcie_ip_txs_agent_rdata_fifo_src_data;                                     // pcie_ip_txs_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          pcie_ip_txs_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_001:in_0_ready -> pcie_ip_txs_agent:rdata_fifo_src_ready
	...
	altera_merlin_master_agent #(
		...
		.rp_valid              (sgdma_descriptor_read_rsp_width_adapter_src_valid),                        //        rp.valid
		.rp_data               (sgdma_descriptor_read_rsp_width_adapter_src_data),                         //          .data
		.rp_channel            (sgdma_descriptor_read_rsp_width_adapter_src_channel),                      //          .channel
		.rp_startofpacket      (sgdma_descriptor_read_rsp_width_adapter_src_startofpacket),                //          .startofpacket
		.rp_endofpacket        (sgdma_descriptor_read_rsp_width_adapter_src_endofpacket),                  //          .endofpacket
		.rp_ready              (sgdma_descriptor_read_rsp_width_adapter_src_ready),                        //          .ready
		.av_response           (),                                                                         // (terminated)
		.av_writeresponsevalid ()                                                                          // (terminated)
	);
	...
	altera_merlin_master_agent #(
		...
		.rp_valid              (sgdma_descriptor_write_rsp_width_adapter_src_valid),                        //        rp.valid
		.rp_data               (sgdma_descriptor_write_rsp_width_adapter_src_data),                         //          .data
		.rp_channel            (sgdma_descriptor_write_rsp_width_adapter_src_channel),                      //          .channel
		.rp_startofpacket      (sgdma_descriptor_write_rsp_width_adapter_src_startofpacket),                //          .startofpacket
		.rp_endofpacket        (sgdma_descriptor_write_rsp_width_adapter_src_endofpacket),                  //          .endofpacket
		.rp_ready              (sgdma_descriptor_write_rsp_width_adapter_src_ready),                        //          .ready
		.av_response           (),                                                                          // (terminated)
		.av_writeresponsevalid ()                                                                           // (terminated)
	);
	...
	cinnabon_qsys_mm_interconnect_0_router_001 router_002 (
	...
	cinnabon_qsys_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (pcie_ip_pcie_core_clk_clk),                  //        clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset),    //  clk_reset.reset
	...
	cinnabon_qsys_mm_interconnect_0_cmd_demux cmd_demux_003 (
		.clk                (pcie_ip_pcie_core_clk_clk),                                 //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
		.sink_ready         (sgdma_descriptor_read_cmd_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (sgdma_descriptor_read_cmd_width_adapter_src_channel),       //          .channel
		.sink_data          (sgdma_descriptor_read_cmd_width_adapter_src_data),          //          .data
		.sink_startofpacket (sgdma_descriptor_read_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (sgdma_descriptor_read_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (sgdma_descriptor_read_cmd_width_adapter_src_valid),         //          .valid
	...
	cinnabon_qsys_mm_interconnect_0_cmd_demux cmd_demux_004 (
		.clk                (pcie_ip_pcie_core_clk_clk),                                  //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset),                    // clk_reset.reset
		.sink_ready         (sgdma_descriptor_write_cmd_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (sgdma_descriptor_write_cmd_width_adapter_src_channel),       //          .channel
		.sink_data          (sgdma_descriptor_write_cmd_width_adapter_src_data),          //          .data
		.sink_startofpacket (sgdma_descriptor_write_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (sgdma_descriptor_write_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (sgdma_descriptor_write_cmd_width_adapter_src_valid),         //          .valid
	...
	cinnabon_qsys_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cinnabon_qsys_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cinnabon_qsys_mm_interconnect_0_rsp_mux_001 rsp_mux_002 (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cinnabon_qsys_mm_interconnect_0_rsp_mux rsp_mux_003 (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cinnabon_qsys_mm_interconnect_0_rsp_mux rsp_mux_004 (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
	...
	) sgdma_descriptor_read_rsp_width_adapter (
		.clk                  (pcie_ip_pcie_core_clk_clk),                                 //       clk.clk
		.reset                (sgdma_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
		...
		.out_endofpacket      (sgdma_descriptor_read_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sgdma_descriptor_read_rsp_width_adapter_src_data),          //          .data
		.out_channel          (sgdma_descriptor_read_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (sgdma_descriptor_read_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (sgdma_descriptor_read_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sgdma_descriptor_read_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) sgdma_descriptor_write_rsp_width_adapter (
		.clk                  (pcie_ip_pcie_core_clk_clk),                                  //       clk.clk
		.reset                (sgdma_reset_reset_bridge_in_reset_reset),                    // clk_reset.reset
		...
		.out_endofpacket      (sgdma_descriptor_write_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sgdma_descriptor_write_rsp_width_adapter_src_data),          //          .data
		.out_channel          (sgdma_descriptor_write_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (sgdma_descriptor_write_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (sgdma_descriptor_write_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sgdma_descriptor_write_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                      // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) sgdma_descriptor_read_cmd_width_adapter (
		.clk                  (pcie_ip_pcie_core_clk_clk),                                 //       clk.clk
		.reset                (sgdma_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
		...
		.out_endofpacket      (sgdma_descriptor_read_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sgdma_descriptor_read_cmd_width_adapter_src_data),          //          .data
		.out_channel          (sgdma_descriptor_read_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (sgdma_descriptor_read_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (sgdma_descriptor_read_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sgdma_descriptor_read_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                     // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) sgdma_descriptor_write_cmd_width_adapter (
		.clk                  (pcie_ip_pcie_core_clk_clk),                                  //       clk.clk
		.reset                (sgdma_reset_reset_bridge_in_reset_reset),                    // clk_reset.reset
		...
		.out_endofpacket      (sgdma_descriptor_write_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sgdma_descriptor_write_cmd_width_adapter_src_data),          //          .data
		.out_channel          (sgdma_descriptor_write_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (sgdma_descriptor_write_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (sgdma_descriptor_write_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sgdma_descriptor_write_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                      // (terminated)
	);
