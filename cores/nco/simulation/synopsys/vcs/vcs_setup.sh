...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/nco_nco_ii_0_sin_c.hex ./
  cp -f $QSYS_SIMDIR/submodules/nco_nco_ii_0_cos_c.hex ./
  cp -f $QSYS_SIMDIR/submodules/nco_nco_ii_0_sin_f.hex ./
  cp -f $QSYS_SIMDIR/submodules/nco_nco_ii_0_cos_f.hex ./
fi
